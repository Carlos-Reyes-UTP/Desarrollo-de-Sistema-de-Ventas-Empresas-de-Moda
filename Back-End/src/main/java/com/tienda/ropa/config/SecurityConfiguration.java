    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity httpSecurity) throws Exception {
        return httpSecurity
                ...
                .authorizeHttpRequests(request -> {
                    request.requestMatchers("/api/admin/**").hasRole(Role.ADMIN.name());
                    request.requestMatchers("/api/cajero/**").hasAnyRole(Role.CAJERO.name(), Role.ADMIN.name());
                    request.requestMatchers("/api/almacenero/**").hasAnyRole(Role.ALMACENERO.name(), Role.ADMIN.name());
