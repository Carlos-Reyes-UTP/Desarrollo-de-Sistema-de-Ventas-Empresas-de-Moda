  ...
  return (
    <div className="p-6">
      ...
      <div className="bg-white rounded-lg shadow-md overflow-hidden">
        ...
        {totalPaginas > 1 && (
          <div className="mt-6 bg-gray-50 border-t border-gray-200 rounded-b-lg">
            {/* Versión móvil */}
            ...
            <div className="hidden sm:flex items-center justify-between px-6 py-3">
              <div className="text-sm text-gray-600">
                ...
                -{Math.min(paginaActual * productosPorPagina, productosFiltrados.length)}
                ...
                {(() => {
                  ...
                  return pages.map((num) =>
                    typeof num === 'number' ? (
                      ...
                      <span key="ellipsis" className="px-2 text-gray-400 select-none text-base">...</span>
                    )
                  );
                })()}
                <button
