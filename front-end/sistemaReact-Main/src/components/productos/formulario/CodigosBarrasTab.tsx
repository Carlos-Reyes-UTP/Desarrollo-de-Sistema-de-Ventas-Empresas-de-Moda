...
const BarcodePlaceholder: React.FC = () => (
  <MaterialIcon
    icon="barcode"
    className="w-[180px] h-14 text-app-text"
    aria-hidden
  />
);
...
const EtiquetaPreviewCard: React.FC<EtiquetaPreviewCardProps> = ({
  ...
  <div className="bg-app-surface rounded-xl p-4 border border-gray-200">
    <div className="bg-app-surface rounded-lg border border-gray-200 shadow-sm p-5 max-w-[280px] mx-auto text-center space-y-3">
      <h5 className="font-bold text-sm text-app-text leading-tight">{nombre}</h5>
    ...
    <div className="space-y-6">
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-start">
        ...
        <div className="space-y-5">
          <div className="p-6 bg-app-surface border border-gray-200 rounded-2xl shadow-sm space-y-4">
            <div className="flex items-center gap-2.5">
              <div className="p-2 bg-app-surface rounded-lg border border-gray-100">
                <MaterialIcon icon="label" className="w-4 h-4 text-app-text" />
              </div>
        ...
        <div className="min-h-[280px] flex flex-col">
          {varianteSeleccionada && codigoBarrasPreview ? (
                  ...
                  <div key={v.id} className="space-y-5 animate-fadeIn">
                    <div className="flex justify-between items-center">
                      ...
                      <button
                        ...
                        className="text-xs font-bold text-gray-500 hover:text-app-text flex items-center gap-1 transition-colors"
                      >
                    ...
                    <div className="bg-app-surface rounded-xl p-4 border border-gray-200">
                      <div className="bg-app-surface rounded-lg border border-gray-200 shadow-sm p-5 max-w-[280px] mx-auto text-center space-y-3">
                        <h5 className="font-bold text-sm text-app-text leading-tight">
                          {formData.nombre}
                        </h5>
                ...
                {variantes.map((variante, index) => {
                  ...
                  return (
                    ...
                    >
                      <div className="flex items-center gap-3.5 min-w-0 flex-1">
                        ...
                        <div className="min-w-0">
                          <div className="flex items-center gap-2">
                            <span className="font-mono font-bold text-xs text-app-text bg-gray-50 px-2 py-0.5 rounded border border-gray-100">
                              T/{tallaNombre}
                            </span>
                      ...
                      <MaterialIcon
                        icon="barcode"
                        className="w-5 h-5 text-gray-300 group-hover:text-app-text transition-colors shrink-0"
                      />
                    </button>
                  );
                })}
            ...
            <div className="flex flex-col items-center justify-center text-center py-12 px-6 bg-app-surface rounded-2xl border border-dashed border-gray-200 flex-1 min-h-[280px]">
              <div className="relative w-20 h-20 rounded-full bg-app-surface border border-gray-200 flex items-center justify-center mb-5">
                <MaterialIcon icon="inventory_2" className="w-10 h-10 text-gray-300" />
                <span className="absolute -bottom-0.5 -right-0.5 w-7 h-7 rounded-full bg-app-surface border border-gray-200 flex items-center justify-center shadow-sm">
